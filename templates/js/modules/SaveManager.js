...
export class SaveManager {
    ...
    save(gameState) {
        const saveData = {
            ...
            displayBoss: gameState.displayBoss,
        ...
        gameState.notificationManager.showNotification('Partie sauvegardée !', 'success');
    }
    ...
    load(gameState) {
        ...
        if (saveData) {
            ...
            // Restaurer le boss d'affichage
            if (data.displayBoss) {
                gameState.displayBoss = data.displayBoss;
            } else {
                gameState.displayBoss = null;
            }
    ...
    newGame(gameState) {
        ...
        console.log('newGame() - Rang initialisé:', gameState.rank);
        console.log('newGame() - RANKS.indexOf(gameState.rank):', gameState.RANKS.indexOf(gameState.rank));
